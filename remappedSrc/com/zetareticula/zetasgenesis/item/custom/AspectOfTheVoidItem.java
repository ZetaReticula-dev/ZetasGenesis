...
public class AspectOfTheVoidItem extends Item {
    ...
    public AspectOfTheVoidItem(net.minecraft.item.Item.Settings settings, int instantRange, int teleportationRange, int fallDamage, int useDamage, int instantDamage, int cooldownTick) {
        super(settings);
