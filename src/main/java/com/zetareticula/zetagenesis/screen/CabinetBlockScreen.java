...
public class CabinetBlockScreen extends HandledScreen<CabinetBlockScreenHandler> {
    private static final Identifier TEXTURE = ZetaGenesis.id("textures/gui/container/generic_27.png");

    public CabinetBlockScreen(CabinetBlockScreenHandler handler, PlayerInventory inventory, Text title) {
