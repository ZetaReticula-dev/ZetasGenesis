...
public class WarpedAspectOfTheVoidItem extends Item {
    private static final int COOLDOWN_TICKS = 140;  // 10 seconds cooldown (20 ticks = 1 second)


    public WarpedAspectOfTheVoidItem(Settings settings) {
        super(settings);
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient) {  // Only execute on the server side
            ...
            double maxDistance = player.isSneaking() ? 60.0D : 14.0D;
