...
public class MulitoolItem extends ToolItem {

    public MulitoolItem(ToolMaterial toolMaterial, Item.Settings settings) {
        super(toolMaterial, settings.component(DataComponentTypes.TOOL, createToolComponent()));
    }

    private static ToolComponent createToolComponent() {
        return new ToolComponent(
                List.of(ToolComponent.Rule.ofAlwaysDropping(List.of(Blocks.COBWEB), 5.0F), ToolComponent.Rule.ofAlwaysDropping(BlockTags.SWORD_EFFICIENT, 5.0F),
                        ToolComponent.Rule.ofAlwaysDropping(BlockTags.AXE_MINEABLE,5.0F),
                        ToolComponent.Rule.ofAlwaysDropping(BlockTags.PICKAXE_MINEABLE,5.0F), ToolComponent.Rule.ofAlwaysDropping(BlockTags.SHOVEL_MINEABLE,5.0F),
