package com.zetareticula.zetasgenesis.item.custom;

import com.google.common.collect.BiMap;
import com.google.common.collect.ImmutableMap;
import com.zetareticula.zetasgenesis.data.provider.GenesisBlockTagProvider;
...
public class PickAndAxe extends MiningToolItem {
    protected static final Map<Block, Block> STRIPPED_BLOCKS;
    public PickAndAxe(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
        super(material, GenesisBlockTagProvider.PICKANDAXE_MINEABLE, attackDamage, attackSpeed, settings);
    }
